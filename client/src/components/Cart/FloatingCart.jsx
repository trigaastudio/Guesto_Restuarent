  ...
  if (isMinimized) {
    return (
      <button
        ...
        className="hidden lg:flex fixed top-1/2 right-0 -translate-y-1/2 z-[999] bg-primary text-white p-3 py-4 rounded-l-2xl shadow-[0_10px_40px_rgba(185,28,28,0.4)] flex-col items-center gap-3 hover:pr-5 transition-all group border border-r-0 border-white/20"
      >
