    ...
    <div className="min-h-screen bg-[#FAF9F6]">
      ...
      <div className="bg-[#D10000]">
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center gap-4 relative z-10 pb-4">
          ...
          <h1 className="text-white font-black text-lg uppercase tracking-widest">Payment</h1>
        </div>
      </div>
      ...
      <main className="max-w-7xl mx-auto px-6 pt-4 pb-16">
        <div className="flex flex-col lg:flex-row gap-10 items-start">
          ...
          <div className="flex-1 space-y-8 w-full">
            ...
            <div className="bg-[#FAF9F6] rounded-[2rem] p-8 border border-[#D10000]/5 shadow-[0_10px_40px_rgba(0,0,0,0.02)]">
              ...
              <div className="bg-white/50 rounded-2xl p-5 border border-gray-100">
                <div className="flex justify-between items-start mb-2">
                  <span className="text-[10px] font-black uppercase tracking-widest text-[#D10000] bg-[#D10000]/5 px-2 py-0.5 rounded-md">
                  ...
                  <div key={item._id} className="flex items-center justify-between group">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Quantity: {item.quantity}</p>
                      </div>
                    </div>
          ...
          <div className="w-full lg:w-[420px] sticky top-32">
            <div className="bg-[#FAF9F6] rounded-[3rem] p-8 border border-primary/10 shadow-[0_30px_100px_rgba(0,0,0,0.04)] relative overflow-hidden">
              {/* Decorative Blur */}
              <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2"></div>

              <h2 className="text-2xl font-black text-text-primary tracking-tight mb-8 relative z-10">Payment Method</h2>

              <div className="space-y-4 mb-8 relative z-10">
                {/* Online Payment Option */}
                <div
                  onClick={() => setPaymentMethod('online')}
                  className={`cursor-pointer p-5 rounded-[1.8rem] border-2 transition-all duration-300 flex items-center justify-between ${paymentMethod === 'online' ? 'border-[#D10000] bg-[#D10000]/5 shadow-md' : 'border-gray-100 bg-white hover:border-[#D10000]/20'}`}
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Cards, UPI, Netbanking</p>
                    </div>
                  </div>
                ...
                <div
                  ...
                  className={`cursor-pointer p-5 rounded-[1.8rem] border-2 transition-all duration-300 flex items-center justify-between ${paymentMethod === 'cod' ? 'border-[#D10000] bg-[#D10000]/5 shadow-md' : 'border-gray-100 bg-white hover:border-[#D10000]/20'}`}
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Pay when you receive</p>
                    </div>
                  </div>
              ...
              {/* Price Breakdown */}
              <div className="bg-gray-50/50 rounded-2xl p-5 mb-8 space-y-3 relative z-10 border border-gray-100">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-2xl font-black text-[#D10000] tracking-tighter">₹{total}</span>
                </div>
              </div>

              {/* Trust Badge */}
              <div className="flex items-center gap-3 justify-center mb-8 opacity-40">
                <ShieldCheck size={14} className="text-green-600" />
                <span className="text-[8px] font-black uppercase tracking-[0.2em]">Secure Checkout Guaranteed</span>
              </div>
              ...
              <button
                ...
                disabled={loading}
                className="w-full bg-[#DA9133] text-white font-black py-5 rounded-[2rem] hover:shadow-[0_20px_50px_rgba(218,145,51,0.3)] transition-all flex items-center justify-center gap-3 group relative overflow-hidden disabled:opacity-50"
              >
                ...
                <span className="relative z-10 text-sm uppercase tracking-[0.2em]">{loading ? 'Processing...' : 'Place Order'}</span>
